 ...
 */
 ...
 class mathlib{
      ...
      * @param num1 The number (must be a non-negative integer and <= 12).
      * @return Factorial of num1.
      * @throws std::runtime_error if num1 is negative, non-integer, or greater than 12.
      */
 
     static int factorial(double num1){
         if (num1 < 0 || num1 != static_cast<int>(num1)){
             throw std::runtime_error("Factorials can be only of natural numbers");
         }
         if (num1 > 12){
     ...
     static double square_root(double base, double degree){
         if(degree <= 1 || degree != static_cast<int>(degree)){
